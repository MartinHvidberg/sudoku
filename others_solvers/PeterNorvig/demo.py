...
if __name__ == '__main__':
    test()
    solve_all(from_file("../../data/text/easy50.txt", '========'), "easy", None)
    solve_all(from_file("../../data/text/top95.txt"), "hard", None)
    solve_all(from_file("../../data/text/hardest.txt"), "hardest", None)
